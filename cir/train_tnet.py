...
lr_decay_gamma = 0.8
if Material == 'Meta':
    params_min = torch.tensor([50, 70, 50, 10, 20])#l, t, t2, w
...
if Material == 'Meta':
    data = h5py.File('data/pcr298.mat', 'r')
    StartWL = 300
    EndWL = 1501
    Resolution = 3
...
#optimizer = AdaBelief(rnet.parameters(), lr=lr, eps=1e-12, betas=(0.9, 0.999), weight_decouple=False, rectify=False)
